...
pm_def.INPUT_DATA_FORMAT = 'PM';      % 'RI' = load two real and 
                                      ...
                                      % pairs.
pm_def.SHORT_ECHO_TIME = 5.19;        % Short echo time in ms for Allegra
pm_def.LONG_ECHO_TIME =  7.65;        % Long echo time in ms for Allegra
...
pm_def.TOTAL_EPI_READOUT_TIME = 28.8;   % Allegra EPI RO time (330E-6*64)
